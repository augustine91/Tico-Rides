...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>/assets/config.css">
    <script src="<?=base_url()?>/JS/bootstrap.min.js"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
    <script src="<?=base_url()?>/JS/Logica.js" charset="utf-8"></script>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#">Accesar
          <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="#">
                                    <input id="user-reg" class="form-control" type="text" placeholder="user">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <input id="pass-reg" class="form-control" type="password" placeholder="Pass">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <button onclick="logueo()" class="btn btn-default">Entrar</button>
                                </a>
                            </li>
                        </ul>
                    </li>
